...
const elementExplorer = [
  { number: 1, symbol: "H", name: "Hydrogen", category: "Phi kim", application: "Nhiên liệu sạch cho pin nhiên liệu và nguyên liệu sản xuất ammonia.", fact: "Là nguyên tố nhẹ nhất và phổ biến nhất trong vũ trụ.", icon: Rocket, visualLabel: "Nhiên liệu sạch", tone: "sky", image: getAssetPath("/element-visuals/h.webp") },
  { number: 6, symbol: "C", name: "Carbon", category: "Phi kim", application: "Than chì trong ruột bút chì, điện cực và vật liệu graphene.", fact: "Kim cương và than chì đều được tạo nên từ carbon.", icon: Pencil, visualLabel: "Bút chì & vật liệu", tone: "ink", image: getAssetPath("/element-visuals/c.webp") },
  { number: 7, symbol: "N", name: "Nitrogen", category: "Phi kim", application: "Bảo quản thực phẩm và sản xuất phân bón cho cây trồng.", fact: "Khoảng 78% không khí quanh ta là nitrogen.", icon: Sprout, visualLabel: "Nông nghiệp", tone: "sky", image: getAssetPath("/element-visuals/n.webp") },
  { number: 8, symbol: "O", name: "Oxygen", category: "Phi kim", application: "Hô hấp y tế, luyện kim và hỗ trợ quá trình đốt cháy.", fact: "Oxygen chiếm gần 21% thể tích không khí.", icon: Stethoscope, visualLabel: "Hô hấp & y tế", tone: "sky", image: getAssetPath("/element-visuals/o.webp") },
  { number: 11, symbol: "Na", name: "Sodium", category: "Kim loại kiềm", application: "Muối ăn, sản xuất thủy tinh và công nghệ pin sodium-ion.", fact: "Sodium kim loại phản ứng mạnh nên không tồn tại tự do trong tự nhiên.", icon: BatteryCharging, visualLabel: "Pin sodium-ion", tone: "gold", image: getAssetPath("/element-visuals/na.webp") },
  { number: 12, symbol: "Mg", name: "Magnesium", category: "Kim loại kiềm thổ", application: "Hợp kim nhẹ cho xe, máy bay và pháo sáng.", fact: "Magnesium cháy tạo ánh sáng trắng rất mạnh.", icon: Plane, visualLabel: "Hợp kim nhẹ", tone: "gold", image: getAssetPath("/element-visuals/mg.webp") },
  { number: 13, symbol: "Al", name: "Aluminium", category: "Kim loại", application: "Lon nước, giấy bạc, khung cửa và vật liệu hàng không.", fact: "Nhẹ, bền và có thể tái chế nhiều lần.", icon: Package, visualLabel: "Bao bì & hàng không", tone: "mint", image: getAssetPath("/element-visuals/al.webp") },
  { number: 14, symbol: "Si", name: "Silicon", category: "Á kim", application: "Chip điện tử, tấm pin mặt trời và sản xuất thủy tinh.", fact: "Silicon là nguyên tố phổ biến thứ hai trong vỏ Trái Đất.", icon: Sun, visualLabel: "Pin mặt trời & chip", tone: "violet", image: getAssetPath("/element-visuals/si.webp") },
  { number: 17, symbol: "Cl", name: "Chlorine", category: "Halogen", application: "Khử khuẩn nước và sản xuất nhựa PVC.", fact: "Trong muối ăn, chlorine tồn tại an toàn ở dạng ion chloride.", icon: Droplets, visualLabel: "Khử khuẩn nước", tone: "violet", image: getAssetPath("/element-visuals/cl.webp") },
  { number: 20, symbol: "Ca", name: "Calcium", category: "Kim loại kiềm thổ", application: "Vật liệu xây dựng; ion calcium quan trọng với xương và răng.", fact: "Đá vôi có thành phần chính là calcium carbonate.", icon: Bone, visualLabel: "Xương & vật liệu", tone: "gold", image: getAssetPath("/element-visuals/ca.webp") },
  { number: 26, symbol: "Fe", name: "Iron", category: "Kim loại chuyển tiếp", application: "Sản xuất thép cho cầu đường, nhà ở và máy móc.", fact: "Ion iron là thành phần quan trọng trong hemoglobin.", icon: Construction, visualLabel: "Thép xây dựng", tone: "mint", image: getAssetPath("/element-visuals/fe.webp") },
  { number: 29, symbol: "Cu", name: "Copper", category: "Kim loại chuyển tiếp", application: "Dây điện, động cơ và thiết bị điện tử nhờ dẫn điện tốt.", fact: "Copper có màu đỏ cam đặc trưng.", icon: Cable, visualLabel: "Dây điện & điện tử", tone: "mint", image: getAssetPath("/element-visuals/cu.webp") },
  { number: 19, symbol: "K", name: "Potassium", category: "Kim loại kiềm", application: "Thành phần chính trong phân bón kali cho cây trồng.", fact: "Potassium phản ứng mạnh với nước và cháy với ngọn lửa tím đặc trưng.", icon: Wheat, visualLabel: "Phân bón cây trồng", tone: "gold", image: getAssetPath("/element-visuals/k.webp") },
  { number: 16, symbol: "S", name: "Sulfur", category: "Phi kim", application: "Sản xuất axit sulfuric, diêm và lưu hóa cao su.", fact: "Sulfur có màu vàng đặc trưng, thường gặp quanh miệng núi lửa.", icon: Mountain, visualLabel: "Công nghiệp hóa chất", tone: "gold", image: getAssetPath("/element-visuals/s.webp") },
  { number: 15, symbol: "P", name: "Phosphorus", category: "Phi kim", application: "Sản xuất phân bón, diêm quẹt và có trong DNA, xương.", fact: "Phosphorus trắng phát quang trong bóng tối và rất độc.", icon: Dna, visualLabel: "Phân bón & xương", tone: "violet", image: getAssetPath("/element-visuals/p.webp") },
  { number: 30, symbol: "Zn", name: "Zinc", category: "Kim loại chuyển tiếp", application: "Mạ kẽm chống gỉ cho thép và hợp kim đồng thau.", fact: "Cơ thể người cần một lượng nhỏ zinc để hỗ trợ hệ miễn dịch.", icon: ShieldCheck, visualLabel: "Mạ chống gỉ", tone: "mint", image: getAssetPath("/element-visuals/zn.webp") },
  { number: 24, symbol: "Cr", name: "Chromium", category: "Kim loại chuyển tiếp", application: "Mạ crôm sáng bóng và tạo độ bền cho thép không gỉ (inox).", fact: "Chromium là thành phần giúp thép không gỉ chống ăn mòn.", icon: Wrench, visualLabel: "Thép không gỉ", tone: "sky", image: getAssetPath("/element-visuals/cr.webp") },
  { number: 56, symbol: "Ba", name: "Barium", category: "Kim loại kiềm thổ", application: "Barium sulfate dùng trong chụp X-quang đường tiêu hóa.", fact: "Barium kim loại độc, nhưng hợp chất barium sulfate không tan nên an toàn khi dùng y tế.", icon: ScanLine, visualLabel: "Chụp X-quang", tone: "ink", image: getAssetPath("/element-visuals/ba.webp") },
  { number: 25, symbol: "Mn", name: "Manganese", category: "Kim loại chuyển tiếp", application: "Hợp kim thép cường độ cao và sản xuất pin khô.", fact: "Cơ thể người cần một lượng rất nhỏ manganese mỗi ngày.", icon: BatteryCharging, visualLabel: "Thép & pin khô", tone: "mint", image: getAssetPath("/element-visuals/mn.webp") },
