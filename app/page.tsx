...
const elementExplorer = [
  { number: 1, symbol: "H", name: "Hydrogen", category: "Phi kim", application: "Nhiên liệu sạch cho pin nhiên liệu và nguyên liệu sản xuất ammonia.", fact: "Là nguyên tố nhẹ nhất và phổ biến nhất trong vũ trụ.", icon: Rocket, visualLabel: "Nhiên liệu sạch", tone: "sky", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Hydrogen_discharge_tube.jpg/330px-Hydrogen_discharge_tube.jpg" },
  { number: 6, symbol: "C", name: "Carbon", category: "Phi kim", application: "Than chì trong ruột bút chì, điện cực và vật liệu graphene.", fact: "Kim cương và than chì đều được tạo nên từ carbon.", icon: Pencil, visualLabel: "Bút chì & vật liệu", tone: "ink", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Graphite-and-diamond-with-scale.jpg/330px-Graphite-and-diamond-with-scale.jpg" },
  { number: 7, symbol: "N", name: "Nitrogen", category: "Phi kim", application: "Bảo quản thực phẩm và sản xuất phân bón cho cây trồng.", fact: "Khoảng 78% không khí quanh ta là nitrogen.", icon: Sprout, visualLabel: "Nông nghiệp", tone: "sky", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Fluessiger_Stickstoff.jpg/330px-Fluessiger_Stickstoff.jpg" },
  { number: 8, symbol: "O", name: "Oxygen", category: "Phi kim", application: "Hô hấp y tế, luyện kim và hỗ trợ quá trình đốt cháy.", fact: "Oxygen chiếm gần 21% thể tích không khí.", icon: Stethoscope, visualLabel: "Hô hấp & y tế", tone: "sky", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Liquid_oxygen_in_a_beaker_%28cropped_and_retouched%29.jpg/330px-Liquid_oxygen_in_a_beaker_%28cropped_and_retouched%29.jpg" },
  { number: 11, symbol: "Na", name: "Sodium", category: "Kim loại kiềm", application: "Muối ăn, sản xuất thủy tinh và công nghệ pin sodium-ion.", fact: "Sodium kim loại phản ứng mạnh nên không tồn tại tự do trong tự nhiên.", icon: BatteryCharging, visualLabel: "Pin sodium-ion", tone: "gold", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Na_%28Sodium%29.jpg/330px-Na_%28Sodium%29.jpg" },
  { number: 12, symbol: "Mg", name: "Magnesium", category: "Kim loại kiềm thổ", application: "Hợp kim nhẹ cho xe, máy bay và pháo sáng.", fact: "Magnesium cháy tạo ánh sáng trắng rất mạnh.", icon: Plane, visualLabel: "Hợp kim nhẹ", tone: "gold", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/CSIRO_ScienceImage_2893_Crystalised_magnesium.jpg/330px-CSIRO_ScienceImage_2893_Crystalised_magnesium.jpg" },
  { number: 13, symbol: "Al", name: "Aluminium", category: "Kim loại", application: "Lon nước, giấy bạc, khung cửa và vật liệu hàng không.", fact: "Nhẹ, bền và có thể tái chế nhiều lần.", icon: Package, visualLabel: "Bao bì & hàng không", tone: "mint", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Aluminium-4.jpg/330px-Aluminium-4.jpg" },
  { number: 14, symbol: "Si", name: "Silicon", category: "Á kim", application: "Chip điện tử, tấm pin mặt trời và sản xuất thủy tinh.", fact: "Silicon là nguyên tố phổ biến thứ hai trong vỏ Trái Đất.", icon: Sun, visualLabel: "Pin mặt trời & chip", tone: "violet", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/SiliconCroda.jpg/330px-SiliconCroda.jpg" },
  { number: 17, symbol: "Cl", name: "Chlorine", category: "Halogen", application: "Khử khuẩn nước và sản xuất nhựa PVC.", fact: "Trong muối ăn, chlorine tồn tại an toàn ở dạng ion chloride.", icon: Droplets, visualLabel: "Khử khuẩn nước", tone: "violet", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Chlorine_in_bottle.jpg/330px-Chlorine_in_bottle.jpg" },
  { number: 20, symbol: "Ca", name: "Calcium", category: "Kim loại kiềm thổ", application: "Vật liệu xây dựng; ion calcium quan trọng với xương và răng.", fact: "Đá vôi có thành phần chính là calcium carbonate.", icon: Bone, visualLabel: "Xương & vật liệu", tone: "gold", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Calcium_unter_Argon_Schutzgasatmosph%C3%A4re.jpg/330px-Calcium_unter_Argon_Schutzgasatmosph%C3%A4re.jpg" },
  { number: 26, symbol: "Fe", name: "Iron", category: "Kim loại chuyển tiếp", application: "Sản xuất thép cho cầu đường, nhà ở và máy móc.", fact: "Ion iron là thành phần quan trọng trong hemoglobin.", icon: Construction, visualLabel: "Thép xây dựng", tone: "mint", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Iron_electrolytic_and_1cm3_cube.jpg/330px-Iron_electrolytic_and_1cm3_cube.jpg" },
  { number: 29, symbol: "Cu", name: "Copper", category: "Kim loại chuyển tiếp", application: "Dây điện, động cơ và thiết bị điện tử nhờ dẫn điện tốt.", fact: "Copper có màu đỏ cam đặc trưng.", icon: Cable, visualLabel: "Dây điện & điện tử", tone: "mint", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/NatCopper.jpg/330px-NatCopper.jpg" },
  { number: 19, symbol: "K", name: "Potassium", category: "Kim loại kiềm", application: "Thành phần chính trong phân bón kali cho cây trồng.", fact: "Potassium phản ứng mạnh với nước và cháy với ngọn lửa tím đặc trưng.", icon: Wheat, visualLabel: "Phân bón cây trồng", tone: "gold", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Potassium-2.jpg/330px-Potassium-2.jpg" },
  { number: 16, symbol: "S", name: "Sulfur", category: "Phi kim", application: "Sản xuất axit sulfuric, diêm và lưu hóa cao su.", fact: "Sulfur có màu vàng đặc trưng, thường gặp quanh miệng núi lửa.", icon: Mountain, visualLabel: "Công nghiệp hóa chất", tone: "gold", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Sulfur_-_El_Desierto_mine%2C_San_Pablo_de_Napa%2C_Daniel_Campos_Province%2C_Potos%C3%AD%2C_Bolivia.jpg/330px-Sulfur_-_El_Desierto_mine%2C_San_Pablo_de_Napa%2C_Daniel_Campos_Province%2C_Potos%C3%AD%2C_Bolivia.jpg" },
  { number: 15, symbol: "P", name: "Phosphorus", category: "Phi kim", application: "Sản xuất phân bón, diêm quẹt và có trong DNA, xương.", fact: "Phosphorus trắng phát quang trong bóng tối và rất độc.", icon: Dna, visualLabel: "Phân bón & xương", tone: "violet", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Phosphor_rot.jpg/330px-Phosphor_rot.jpg" },
  { number: 30, symbol: "Zn", name: "Zinc", category: "Kim loại chuyển tiếp", application: "Mạ kẽm chống gỉ cho thép và hợp kim đồng thau.", fact: "Cơ thể người cần một lượng nhỏ zinc để hỗ trợ hệ miễn dịch.", icon: ShieldCheck, visualLabel: "Mạ chống gỉ", tone: "mint", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Zinc_fragment_sublimed_and_1cm3_cube.jpg/330px-Zinc_fragment_sublimed_and_1cm3_cube.jpg" },
  { number: 24, symbol: "Cr", name: "Chromium", category: "Kim loại chuyển tiếp", application: "Mạ crôm sáng bóng và tạo độ bền cho thép không gỉ (inox).", fact: "Chromium là thành phần giúp thép không gỉ chống ăn mòn.", icon: Wrench, visualLabel: "Thép không gỉ", tone: "sky", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Chromium_crystals_and_1cm3_cube.jpg/330px-Chromium_crystals_and_1cm3_cube.jpg" },
  { number: 56, symbol: "Ba", name: "Barium", category: "Kim loại kiềm thổ", application: "Barium sulfate dùng trong chụp X-quang đường tiêu hóa.", fact: "Barium kim loại độc, nhưng hợp chất barium sulfate không tan nên an toàn khi dùng y tế.", icon: ScanLine, visualLabel: "Chụp X-quang", tone: "ink", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Barium_unter_Argon_Schutzgas_Atmosph%C3%A4re.jpg/330px-Barium_unter_Argon_Schutzgas_Atmosph%C3%A4re.jpg" },
  { number: 25, symbol: "Mn", name: "Manganese", category: "Kim loại chuyển tiếp", application: "Hợp kim thép cường độ cao và sản xuất pin khô.", fact: "Cơ thể người cần một lượng rất nhỏ manganese mỗi ngày.", icon: BatteryCharging, visualLabel: "Thép & pin khô", tone: "mint", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Manganese_electrolytic_and_1cm3_cube.jpg/330px-Manganese_electrolytic_and_1cm3_cube.jpg" },
  { number: 35, symbol: "Br", name: "Bromine", category: "Halogen", application: "Khử trùng nước hồ bơi và sản xuất một số loại thuốc.", fact: "Bromine là phi kim duy nhất ở thể lỏng tại nhiệt độ phòng.", icon: Waves, visualLabel: "Khử trùng nước hồ bơi", tone: "violet", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Bromine_vial_in_acrylic_cube.jpg/330px-Bromine_vial_in_acrylic_cube.jpg" },
];
      ...
      <section className="hero" id="main-content">
        ...
        <div className="hero-visual" aria-label="Minh họa lớp học Hóa ChamChamEdemy">
          ...
          <div className="floating-card float-bottom">
            <span aria-hidden="true">02</span><div><strong>Giảng trực quan</strong><small>Dễ hiểu · dễ nhớ</small></div>
          </div>
        </div>
      </section>
        ...
        <div className="game-shell" data-reveal>
            ...
            <div className="element-grid" aria-label="Các nguyên tố để khám phá">
              {elementExplorer.map((element) => (
                ...
                >
                  ...
                  <span className="element-tile-photo" aria-hidden="true"><img src={element.image} alt="" loading="lazy" referrerPolicy="no-referrer" /></span><i aria-hidden="true">✓</i>
                </button>
              ))}
            </div>
          </div>
          ...
          <aside className={`element-result ${activeElement.tone} ${resultOpen ? "is-open" : ""}`} aria-live="polite">
            ...
            <div className="result-identity">
              ...
              <div className="element-illustration" aria-label={`Ảnh minh họa nguyên tố ${activeElement.name}`}><span><img src={activeElement.image} alt={`Ảnh nguyên tố ${activeElement.name}`} referrerPolicy="no-referrer" /></span><small>{activeElement.visualLabel}</small></div>
            </div>
      ...
      <section className="proof-section" id="phuong-phap">
        ...
        <div className="register-panel" id="dang-ky" data-reveal>
          ...
          <form onSubmit={handleRegister}>
            ...
            {submitStatus === "error" && (
              <div className="message-preview" role="alert" aria-live="assertive">
                <p>{fallbackMessage}</p>
                <div>
