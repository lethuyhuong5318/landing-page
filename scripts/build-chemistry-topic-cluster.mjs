...
function lessonNav(index) {
  ...
  <header class="cluster-lesson-header">
    ...
    <h1>${lesson.title}</h1><p>${lesson.description}</p><div class="cluster-lesson-side" aria-label="Diem hoc tap"><div class="xp-badge cluster-xp-compact" id="xpBadge"><span class="xp-num" id="xpNum">0</span><span class="xp-lbl">&#272;i&#7875;m</span><span class="lvl-lbl" id="lvlLbl">C&#7845;p 1</span></div><div class="mascot-badge"><img src="/co-tram-mascot.webp" alt="Mascot ChamChamEdemy"></div></div>
  </header>
